...
/**
 * HasOneThrough relationship with multiple column support for DB2.
 * DB2 doesn't support tuple IN syntax, so we use OR/AND conditions instead.
 */
class HasOneThroughMultiple extends HasOneThrough
{
    /**
    ...
    public function match(array $models, Collection $results, $relation)
    {
        ...
        // Note: DB2 uppercases column aliases, so we check both cases
        $dictionary = [];
